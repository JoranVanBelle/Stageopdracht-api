...
@SpringBootTest(classes = DistanceMatrixInfrastructure.class)
@ActiveProfiles("test")
public class DistanceMatrixInfrastructureTest {
    ...
    private DistanceMatrixInfrastructure distanceMatrixInfrastructureSpy = Mockito.spy(new DistanceMatrixInfrastructure());
    ...
    public void testGetDistanceMatrixResponse() throws Exception {
        ...
        when(distanceMatrixInfrastructureSpy.getNewHttpClient()).thenReturn(httpClient);
        ...
        String actualResponse = distanceMatrixInfrastructureSpy.getDistanceMatrixResponse(distanceMatrixUrl);
